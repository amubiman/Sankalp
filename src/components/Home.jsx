...
function Home() {
  ...
  useEffect(() => {
    ...
    }, { threshold: 0.1 }); // १०% बॉक्स स्क्रीनवर दिसताच ॲनिमेशन सुरू होईल
  ...
  return (
    <div style={{ fontFamily: "'Poppins', sans-serif", backgroundColor: '#fdfdfd', color: '#333' }}>
      ...
      {/* 🟢 नवीन स्वतंत्र हेडर कॉम्पोनंट जोडला */}
      <Header />
      ...
      <div id="home" style={{ marginTop: '80px', width: '100%' }}>
        ...
        <div className="hero-banner" style={{ 
          ...
          {/* 🌟 बदल १: पेज लोड होताच टेक्स्ट स्मूथली वर येईल (hero-animate क्लास जोडला) */}
